...
<html>
	...
	<body>
		...
		<td><button onclick="manage();">Manage</button></td>
    	...
    	function manage(){
			window.open("manage.php", "newwindow", "height=1000, width=1000, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no")
		}
</script>
	</body>
<html>